  ...
  return (
    <section id="cars" className="py-20 bg-gray-50 overflow-hidden font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Cars Grid: 3 items cleanly arranged */}
        <div 
        ...
        >
          {displayedCars.map((car, index) => (
            ...
            >
              ...
              <div className="relative overflow-hidden aspect-[4/3] bg-gradient-to-b from-slate-50 via-white to-slate-100 flex items-center justify-center p-3 sm:p-5">
                <img
                  src={car.image}
                  alt={car.name}
