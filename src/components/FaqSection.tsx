...
export const FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    answerEn: 'Our premier fleet includes the executive Mitsubishi Pajero Sport, the spacious Toyota HiAce Commuter, the next-gen Toyota Innova Zenix, and the versatile Toyota Innova Reborn. We also accommodate custom vehicle requests for special groups. All units are clean, well-maintained, and equipped with chilled AC. Rental service includes an experienced professional driver, fuel options, and parking fee arrangements according to your preferences.',
    answerId: 'Pilihan armada utama kami meliputi Mitsubishi Pajero Sport, Toyota HiAce Commuter, Toyota Innova Zenix, dan Toyota Innova Reborn, serta layanan Request Kendaraan untuk tipe unit lainnya. Seluruh unit dalam kondisi prima, wangi, bersih, dan ber-AC sejuk. Layanan sewa mobil sudah mencakup pengemudi berpengalaman yang ramah dan paham rute Batam, dengan opsi paket bahan bakar (BBM) dan parkir sesuai kebutuhan perjalanan Anda.',
  },
  {
    ...
    answerEn: 'Yes. With our rich experience since 1994, we excel at tailoring vehicle types and fleet quantities to match any corporate, business inspection, or group requirements. We can deploy Toyota HiAce Commuter, Innova Zenix, Innova Reborn, or Pajero Sport with coordinated itineraries and professional drivers.',
    answerId: 'Sangat bisa! Berpengalaman sejak 1994 dalam menyediakan layanan mobil dan driver, kami terbiasa menyediakan Toyota HiAce Commuter, Innova, maupun Pajero Sport untuk kebutuhan perjalanan dinas, kunjungan kawasan industri pabrik, pertemuan bisnis, maupun rombongan group keluarga besar dengan koordinasi yang rapi dan profesional.',
  },
  {
